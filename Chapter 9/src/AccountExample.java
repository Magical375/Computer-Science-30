...
public class AccountExample {
	 ...
	 */
	public AccountExample(double bal, String fName, String lName)//include street, city, province or state, postal code or zip code
	 {
		balance = bal;
		cust = new CustomerExample(fName, lName);//this constructor should reflect the new additions above, street, city, province, postal code
	 ...
	 */
	public AccountExample(String ID) {
		balance = 0;
		cust = new CustomerExample("", "");
		acctID = ID;
	}
	...
	public boolean equals(Object acct) {
		AccountExample testAcct = (AccountExample)acct;
